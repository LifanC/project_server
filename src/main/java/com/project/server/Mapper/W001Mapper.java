...
public interface W001Mapper {
    ...
    ArrayList<GoW0012> goW0012_select_pickers(String params0, String params1, String params2, String params3, String params4);

    ArrayList<GoW001> goW001_select_NewDatelist(ArrayList<String> newDatelist, String params2, String params3, String params4);
}
